...
This folder contains the required files for building and executing the stream benchmark

## Description

STREAM benchmark: A[i] = B[i] + k;
Both CPU and GPU benchmarking were performed. 
## Getting Started
...
* Change the üarameters in the [Makefile](src/stream/Makefile) if necessary
* Run ```make```
